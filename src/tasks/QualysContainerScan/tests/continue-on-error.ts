...
// Mock inputs - continue on error enabled
...
tmr.setInput('continueOnError', 'true'); // This is the key - continue even when policy fails
...
// but we continue because continueOnError=true
